...
author: Nom Auteur
license: MIT
visibility: private   # "public" | "private" (défaut: private)
tags:
  - tag1
  - tag2
...
Visibilité du package. Par défaut : `private`.

```yaml
visibility: public   # Visible par tous, sans authentification
# ou
visibility: private  # Visible uniquement par le propriétaire (défaut)
```

<Info>
  La visibilité peut être modifiée après déploiement via l'API ou l'interface web, sans redéployer le package.
</Info>
