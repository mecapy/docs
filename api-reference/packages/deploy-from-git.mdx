...
<Info>
  Visibility can also be changed after deployment via [`PATCH /packages/{id}/visibility`](/api-reference/packages/update-visibility) without requiring a redeploy.
</Info>
